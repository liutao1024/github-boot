var Vlyspy = function(){
	var dk_dcqs = '0008'; // 易鑫车贷待清算
	var dk_hkqs = '0008'; // 易鑫车贷待清算
	...
	var handlerTable = function(){
			var url = Sunline.ajaxPath("vl/qryVlyShengPayDkRecord");
...
//				}
				...
				Sunline.ajaxRouter(
	            	...
	            	function(redata){
	            		$("#myModal").modal('hide');
	            		bootbox.alert("交易异常哦，请检查网络设置！", function() {
