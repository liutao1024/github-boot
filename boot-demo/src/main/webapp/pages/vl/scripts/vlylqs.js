var Vlylqs = function(){
	var dk_dcqs = '900101300199000015'; //易鑫贷款代偿追回待清算
	var dk_hkqs = '900101300199000016'; //易鑫贷款还款代扣待清算	
	...
	var readFile = function(){
		...
		$('#submit').click(function(){
			...
			Sunline.ajaxRouter(
	        	...
	        	function(redata){
	        		$("#myModal").modal('hide');
	        		bootbox.alert("交易异常，请检查网络设置后重新登录！"); 
	        	},
	        	"json",
	        	false); 
		});
	...
	var handlerTable = function(){
			var url = Sunline.ajaxPath("vl/qryVlyUnionPayDkRecord");
