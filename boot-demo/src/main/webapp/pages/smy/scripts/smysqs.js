var Smyspy = function(){
	/*var dk_dcqs = '0008'; //萨摩耶贷款代偿追回待清算900101300199000007  900101300199000015
	var dk_hkqs = '0008'; //萨摩耶贷款还款代扣待清算900101300199000012  900101300199000016
*/	
	...
	var handlerTable = function(){
			var url = Sunline.ajaxPath("setlle/qrySmyShengPayDkRecord");
...
//				}
				...
				for (var i=0;i<rows.length;i++){
					...
					var fronsq = $(row[9]).text();
					var frondt = $(row[10]).text();
					var custna = $(row[5]).text();
					var custca = $(row[6]).text();
					var chkStatus = _formartDict(chkStatusDict,$(row[11]).text());
