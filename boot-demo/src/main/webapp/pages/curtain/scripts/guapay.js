var Guapay = function(){
	...
	var handlerTable = function(){
		$('.table-container .alert-danger').css("display","none");
			var url = Sunline.ajaxPath("curtain/guche");
		...
		/*	if(Sunline.isNull(inacno)){
			...
			for (i=0;i<rows.length;i++){
				...
				var tranam = $(row[9]).text();
				var toacct = $(row[8]).text();
				...
				var gupysq = $(row[6]).text();
				var gupyno = $(row[7]).text();
