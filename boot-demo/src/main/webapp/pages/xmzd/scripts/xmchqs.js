var xmchqs = function(){
	...
	var xm_tqhk = '900101300102000003'; //小马助贷贷款提前待清算
	var xm_zchk = '900101300199000004'; //小马助贷贷款正常待清算
	var xm_zhdc = '900101300199000005'; //小马助贷贷款追回代偿待清算
	...
	var readFile = function(){
		...
		$('#submit').click(function(){
			...
			var input = {};
			input.trandt = trandt;
			input.xm_tqhk = xm_tqhk;
			input.xm_zchk = xm_zchk;
			input.xm_zhdc = xm_zhdc;
			
			input.chanel = '02';
			$("#myModal").modal('show');
			Sunline.ajaxRouter(
	        	"setlle/getXmPayDkRecord", 
	        	 input,
	        	"POST",
	            function(redata){
	...
	var handlerTable = function(){
			var url = Sunline.ajaxPath("setlle/qryXmPayDkRecord");
			...
			grid.setAjaxParam("xm_tqhk",xm_tqhk);
			grid.setAjaxParam("xm_zchk",xm_zchk);
			grid.setAjaxParam("xm_zhdc",xm_zhdc);
