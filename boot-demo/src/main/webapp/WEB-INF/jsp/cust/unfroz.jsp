	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">单户不进不出解冻</span>
				<span class="caption-helper">单户不进不出解冻</span>
			</div>
		</div>
...
<!-- 解冻弹出窗口 -->
	<div id="unfrozeModel" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" data-width="1000">
		<div class="modal-header">
			...
			<h4 class="modal-title">单户不进不出解冻</h4>
		</div>
...
<script src="${ctx}/pages/cust/scripts/unfroz.js"></script>
<script>
