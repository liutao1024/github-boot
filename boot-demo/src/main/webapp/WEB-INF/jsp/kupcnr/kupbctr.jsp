		...
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-gift font-green-sharp"></i> <span
					class="caption-subject font-green-sharp bold uppercase">交易业务类型对照信息</span>
				<span class="caption-helper">交易业务类型对照信息...</span>
			</div>
		</div>
				...
				<table class="table table-striped table-bordered table-hover"
					...
					<thead>
						<tr role="row" class="heading">
							<th scope="col" >交易处理码</th>
							<th scope="col">业务类型</th>
							<th scope="col" colspan="2">操作</th>
						</tr>
						<tr>
							<td><input type="text" class="form-control form-filter input-sm" id="q_jyclma" name="q_jyclma" /></td>
							<td></td>
			...
			<div id="edittypeModal" class="modal fade" tabindex="-1"
				...
				<div style="height: 280px;">
					<div class="modal-header">
						...
						<h4 class="modal-title">交易业务类型对照信息</h4>
					</div>
									...
									<div class="form-body">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-md-4 control-label">交易处理码</label>
												<div class="col-md-4">
													<input type="text" name="jyclma" id="jyclma"
...
<script src="${ctx}/pages/kupcnr/scripts/kupbctr.js"></script>
<script>
