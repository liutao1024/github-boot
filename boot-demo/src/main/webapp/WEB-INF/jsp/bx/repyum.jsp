	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-gift font-green-sharp"></i> <span
					class="caption-subject font-green-sharp bold uppercase">现金贷放款信息查询</span>
				<span class="caption-helper">现金贷放款信息查询...</span>
			</div>
		</div>
		<div class="portlet-body">
			<form class="form-horizontal cust-form" id="cust-form" role="form">
				...
				<div class="form-group col-md-6">
					<label class="col-md-3 control-label">放款日期</label>
					<div class="input-group col-md-9 input-medium date date-picker"
						data-date-format="yyyymmdd" data-date-viewmode="years"
						data-date-minviewmode="months">
						<input type="text" id="initdt" class="form-control" name="initdt" style="margin-left: 15px;">
...
<script src="${ctx}/pages/bx/scripts/repyum.js"></script>
<script>
