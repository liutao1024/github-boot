	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">萨摩耶包商卡代扣差错处理</span>
				<span class="caption-helper">萨摩耶包商卡代扣差错处理</span>
			</div>
		</div>
		...
		<div class="portlet-body">
		 <div class="table-container">
				<table class="table table-striped table-bordered table-hover" id="cppbsb_ajax">
					<thead>
...
<script src="${ctx}/pages/smy/scripts/smbsqs.js"></script>
<script>
