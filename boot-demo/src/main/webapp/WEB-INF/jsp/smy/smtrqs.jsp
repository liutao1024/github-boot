	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">萨摩耶代偿资金清算</span>
				<span class="caption-helper">萨摩耶代偿资金清算...</span>
			</div>
		</div>
		<div class="portlet-body">
			<form class="file-form form-horizontal" id = "file-form">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4">清算金额</label>
						<div class="input-group col-md-6">
...
<script src="${ctx}/pages/smy/scripts/smtrqs.js"></script>
<script>
