	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">萨摩耶ChinaPay代扣差错处理</span>
				<span class="caption-helper">萨摩耶ChinaPay代扣差错处理</span>
			</div>
		</div>
...
<script src="${ctx}/pages/smy/scripts/smchqs.js"></script>
<script>
