	...
	<div class="portlet light">
		...
		<div class="portlet-body">
			<form class="form-horizontal cust-form" id="cust-form" role="form">
				...
				<div class="form-group col-md-6">
					<label class="col-md-3 control-label">任务批次号</label>
					<div class="input-icon col-md-9">
						<i class="fa fa-book"></i>
						<input type="text" id="btchno" name="btchno" class="form-control input-inline input-medium" maxlength="19" placeholder="输入任务批次号">
					</div>
				</div>
				...
				<form class="form-horizontal mod-form" id="mod-form" role="form">
					...
					<div class="form-group">
						...
						<div class=" input-group col-md-9">						
							...
							<div  style="margin-left: -85px; margin-top:50px;" class="acctna">帐号名称：<span class="name" id="d-acct-i"></span></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" input-group col-md-9">							
							...
							<div  style="margin-left: -85px; margin-top:35px;" class="acctna">帐号名称：<span class="name" id="d-acct-c"></span></div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">过渡户</label>
						<div class=" input-group col-md-9">							
							<input type="text" id="batcac" name="batcac"  maxlength="18" class="form-control input-inline input-medium" >
							<div  style="margin-left: -85px; margin-top:35px;" class="acctna">帐号名称：<span class="name"  id="d-acct-b"></span></div>
						</div>
					</div>
					<div class="form-group">
