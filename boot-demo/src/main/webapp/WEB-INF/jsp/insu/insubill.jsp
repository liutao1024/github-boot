	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">保险退保处理</span>
				<span class="caption-helper">保险退保处理</span>
			</div>
		</div>
		<div class="portlet-body">
			<form action="<%=request.getContextPath()%>/rest/insu/loanFile" id="myfile" class="form-horizontal form-bordered" method="POST" 
...
<script src="${ctx}/pages/insu/scripts/insu.js"></script>
<script>
