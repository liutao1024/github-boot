	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">万能险保险清算</span>
				<span class="caption-helper">万能险保险清算...</span>
			</div>
		</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input type="hidden" id="trantp" name="trantp" class="form-control input-inline input-small " placeholder="清算类别"/>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input type="text" id="checkS"  name="checkS" class="form-control input-inline input-small" placeholder="处理状态"/>
						</div>
					</div>
				</div>
