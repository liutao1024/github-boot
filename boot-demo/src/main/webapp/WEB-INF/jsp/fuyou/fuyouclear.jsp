	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">富友清算</span>
				<span class="caption-helper">富友清算...</span>
			</div>
		</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input type="hidden" id="fycltp" name="fycltp" class="form-control input-inline" placeholder="清算类别"/>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group col-md-9 input-medium input-icon ">
							<i class="fa fa-cny"></i>
							<input type="text" id="tranam" name="tranam" class="form-control placeholder-no-fix" autocomplete="off" disabled placeholder="交易金额,保留两位有效数字"/>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input type="text" id="clerst" readOnly name="clerst" class="form-control input-inline" placeholder="清算状态"/>
						</div>
					</div>
				</div>
				<div class="form-actions file-action col-md-4" style = "text-align:right;">
		...
		<div class="portlet-body">
			<form class="file-form form-horizontal" id = "file-form">
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-3">清算方向</label>
						<div class="input-group col-md-9 input-medium input-icon ">
							<input id="inoutp" name="inoutp" class="form-control placeholder-no-fix" type="text" autocomplete="off" disabled placeholder="清算方向"/>
						</div>
					</div>
				</div>
				<div class="clean">
...
<script src="${ctx}/pages/fuyou/scripts/fuyouclear.js"></script>
<script>
