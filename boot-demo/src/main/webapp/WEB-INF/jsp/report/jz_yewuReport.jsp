	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-helper">查询业务状况报表...</span>
			</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group col-md-12 date input-medium date-picker"
									...
									<input type="text" class="form-control" id = "acctdt" name="acctdt"
...
<script src="${ctx}/pages/report/scripts/jz_yewuReport.js"></script>
<script>
