	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-helper">查询基金申购赎回人数及金额明细报表...</span>
			</div>
		</div>
				...
				<div class="form-body">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="col-md-3 control-label">基金状态</label>
							<div class="col-md-9">
								<div>
									<input type="hidden" id=fundtype name="fundtype" class="form-control input-inline input-medium form-value" placeholder="选择基金状态"/>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-9">
								<div>
									<input type="hidden" id=PRODCD name="PRODCD" class="form-control input-inline input-medium form-value" placeholder="选择基金公司"/>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group col-md-12 date input-medium date-picker"
									...
									<input type="text" class="form-control" name="TRANDT"
...
<script src="${ctx}/pages/report/scripts/fundReport.js"></script>
<script>
