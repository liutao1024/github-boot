	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">营改增开票登记</span>
				<span class="caption-helper">营改增开票登记...</span>
			</div>
		</div>
...
<script src="${ctx}/pages/curtain/scripts/vtbill.js"></script>
<script>
