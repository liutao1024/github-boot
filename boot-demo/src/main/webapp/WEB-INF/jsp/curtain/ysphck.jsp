	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">银盛代付差错记录</span>
				<span class="caption-helper">银盛代付差错记录</span>
			</div>
		</div>
			...
			<form class="file-form form-horizontal" id = "file-form">  
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input id="inacno" name="inacno" class="form-control input-inline" placeholder="清算账户" value="900101300199000018"/>
						</div>
					</div>
				</div>
...
<script src="${ctx}/pages/curtain/scripts/ysphck.js"></script>
<script>
