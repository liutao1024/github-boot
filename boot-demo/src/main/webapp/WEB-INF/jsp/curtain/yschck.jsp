	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">银盛代扣差错记录</span>
				<span class="caption-helper">银盛代扣差错记录</span>
			</div>
		</div>
...
<script src="${ctx}/pages/curtain/scripts/yschck.js"></script>
<script>
