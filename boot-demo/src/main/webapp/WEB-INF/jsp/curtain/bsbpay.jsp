	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">包商卡代付差错处理</span>
				<span class="caption-helper">包商卡代付差错处理</span>
			</div>
		</div>
			...
			<form class="file-form form-horizontal" id = "file-form">  
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input id="inacno" name="inacno" class="form-control input-inline" placeholder="清算账户" value="900101300199000022"/>
						</div>
					</div>
				</div>
...
<script src="${ctx}/pages/curtain/scripts/bsbpay.js"></script>
<script>
