	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">包商卡代扣差错处理</span>
				<span class="caption-helper">包商卡代扣差错处理</span>
			</div>
		</div>
...
<script src="${ctx}/pages/curtain/scripts/bsbtln.js"></script>
<script>
