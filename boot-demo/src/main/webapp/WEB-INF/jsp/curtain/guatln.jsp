	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">广银联代扣差错处理</span>
				<span class="caption-helper">广银联代扣差错处理</span>
			</div>
		</div>
			...
			<form class="file-form form-horizontal" id = "file-form">  
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group col-md-8">
							<input id="inacno" name="inacno" class="form-control input-inline" placeholder="清算账户" value=""/>
						</div>
					</div>
				</div>
		...
		<div class="portlet-body">
		 <div class="table-container">
				<table class="table table-striped table-bordered table-hover" id="gulchk_ajax">
					<thead>
...
<script src="${ctx}/pages/curtain/scripts/guatln.js"></script>
<script>
