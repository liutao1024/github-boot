		...
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-gift font-green-sharp"></i> <span
					class="caption-subject font-green-sharp bold uppercase">银联费用清算记录</span>
				<span class="caption-helper">银联费用清算记录</span>
			</div>
		</div>
		<div class="portlet-body">
			...
			<form class="file-form form-horizontal" id="file-form">
				...
				<div class="form-actions file-action col-md-3">
                    <button type="button" class="btn green" id="find">查询</button>
					<button type="button" class="btn blue" id="submit">导入文件数据</button>
				</div>
			</form>
			<!-- END FILE FORM -->
			<div class="clean"></div>
			...
			<form class="file-form form-horizontal" id="sum-form">
				<div class="col-md-3">
					<div class="form-group row">
						<label class="control-label col-md-5">费用名称：</label>
				...
				<div class="col-md-3">
					<div class="form-group row">
						<label class="control-label col-md-5">费用总额：</label>
						<div class="input-group col-md-5">
							<div id="tranam"></div>
						</div>
					</div>
				...
				<div class="col-md-3 aligh-right">
					<button type="button" class="btn blue" disabled="disabled"
						id="cel_in">清 算</button>
				</div>
			</form>
		</div> -->
...
<script src="${ctx}/pages/curtain/scripts/upfyqs.js"></script>
<script>
