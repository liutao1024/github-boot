	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">广银联代付差错处理</span>
				<span class="caption-helper">广银联代付差错处理</span>
			</div>
		</div>
		...
		<div class="portlet-body">
		 <div class="table-container">
				<table class="table table-striped table-bordered table-hover" id="gupchk_ajax">
					<thead>
...
<script src="${ctx}/pages/curtain/scripts/guapay.js"></script>
<script>
