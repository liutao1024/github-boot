	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">拉卡拉对账差错处理</span>
				<span class="caption-helper">拉卡拉对账差错处理...</span>
			</div>
		</div>
...
<script src="${ctx}/pages/curtain/scripts/lkldiff.js"></script>
<script>
