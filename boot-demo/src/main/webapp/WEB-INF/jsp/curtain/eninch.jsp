	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">总账内部户调账操作</span>
				<span class="caption-helper">总账内部户调账操作...</span>
			</div>
		</div>
		<div class="portlet-body">
			<!-- BEGIN SINGLEDEBT FORM -->
			<form class="eninch-form form-horizontal" id="eninch_form">  
...
<script src="${ctx}/pages/curtain/scripts/eninch.js"></script>
<script>
