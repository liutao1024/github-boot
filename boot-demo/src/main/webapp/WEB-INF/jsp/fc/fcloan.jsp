		...
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-gift font-green-sharp"></i> <span
					class="caption-subject font-green-sharp bold uppercase">小马bank放款处理</span>
				<span class="caption-helper">小马bank放款处理</span>
			</div>
		</div>
		<div class="portlet-body">
			<form action="<%=request.getContextPath()%>/rest/fc/loanFile"
				...
				<div class="form-body">
					<div class="form-group col-md-7">
						<label class="control-label col-md-3">选择放款文件</label>
						<div class="col-md-9">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="input-group input-large">
									...
									<span class="input-group-addon btn default btn-file"> <span
										class="fileinput-new"> 选择放款文件 </span> <span
...
<script src="${ctx}/pages/fc/scripts/fcloan.js"></script>
<script>
