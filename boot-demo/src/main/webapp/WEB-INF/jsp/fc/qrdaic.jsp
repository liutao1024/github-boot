	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">小马bank代偿清算</span>
				<span class="caption-helper">小马bank代偿清算</span>
			</div>
		</div>
		<div class="portlet-body">
			<!-- BEGIN FILE FORM -->
			<form class="file-form form-horizontal" id = "qradicdate">  
		...
		<div class="portlet-body">
		 <div class="table-container">
				<table class="table table-striped table-bordered table-hover" id="qradic_ajax">
					<thead>
...
<script src="${ctx}/pages/fc/scripts/qrdaic.js"></script>
<script>
