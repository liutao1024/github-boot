		...
		<form class="form-horizontal" id = "qry-form">
		            <div class="col-md-8" >
						<div class="form-group">
							<label class="control-label col-md-3">接受柜员</label>
							<div class="input-icon col-md-9">	
								<i class="fa fa-credit-card"></i>
								<input type="text" id="recvid" name="recvid" class="select-close form-control input-inline input-medium" maxlength="18" placeholder="输入接受柜员">
							</div>
						</div>
					</div> 
			...
			<div class="table-container">
				...
				<table class="table table-striped table-bordered table-hover" id="datatable_add1">
					<thead>
							...
							<div class="col-md-12">
								<form class="form-horizontal" role="form">
									...
									<div class="col-md-6">
											...
											<div class="form-group">
												<label class="col-md-4 control-label">待办明细</label>
												<div class="col-md-4">
													<input type="text" name="subjdl"
...
<script src="${ctx}/pages/bbs/scripts/addetail.js"></script>
