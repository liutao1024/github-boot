	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">备付金余额对账单</span>
				<span class="caption-helper">备付金余额对账单</span>
			</div>
		</div>
			 ...
			 <div class="table-container">
				<table class="table table-striped table-bordered table-hover" id="cppchk_ajax">
					<thead>
						...
						<tr><td width="8%" height="30px"><td width="8%" height="30px"><td width="8%" height="30px"><td width="8%" height="30px"></td><td width="8%" height="30px"></td><td width="8%" height="30px"></td><td width="8%" height="30px"></td><td width="8%" height="30px"></td><td width="8%" height="30px"></td></tr>
					</thead>
					<tbody>
					</tbody>
				</table>
...
<script src="${ctx}/pages/liquidation/scripts/wbacct.js"></script>
<script>
