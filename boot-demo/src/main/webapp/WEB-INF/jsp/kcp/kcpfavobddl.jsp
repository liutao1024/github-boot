	...
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift font-green-sharp"></i> <span
				class="caption-subject font-green-sharp bold uppercase">收费累积主体明细表</span>
			<span class="caption-helper">收费累积主体明细表配置...</span>
		</div>
	</div>
			...
			<table class="table table-striped table-bordered table-hover"
				...
				<thead>
					<tr role="row" class="heading">
						...
						<th scope="col">累计主体</th>
						<th scope="col">收费周期</th>
						<th scope="col">累积优惠值</th>
						<th scope="col">最后日期</th>
		...
		<div id="editdefnModal" class="modal fade" tabindex="-1"
			...
			<div>
				<div class="modal-header">
					...
					<h4 class="modal-title">收费累积主体明细表属性</h4>
				</div>
							...
							<form class="form-horizontal" role="form">
								<div class="form-body">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label class="col-md-6 control-label">累积主体</label>
											<div class="col-md-6">
												<input type="text" name="smbody"
													class="form-control input-inline input-medium form-value"
													 placeholder="累积主体">
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-md-6 control-label">累积优惠值</label>
											<div class="col-md-6">
												<input type="text" name="smfavl"
													class="form-control input-inline input-medium form-value"
													maxlength="10" placeholder="累积优惠值">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-6 control-label">最后日期</label>
											<div class="col-md-6">
												<input type="text" name="endate"
													class="form-control input-inline input-medium form-value"
													maxlength="10" placeholder="最后日期">
											</div>
										</div>
										<div class="form-group" hidden="hidden">
											...
											<div class="col-md-6">
												<input type="text" name="inseno"
													class="form-control input-inline input-medium form-value"
													maxlength="10" placeholder="是否新增" hidden="ture">
											</div>
										</div>
									</div>
								</div>
...
<script src="${ctx}/pages/kcp/scripts/kcpfavobddl.js"></script>
<script>
