	...
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift font-green-sharp"></i> <span
				class="caption-subject font-green-sharp bold uppercase">收费优惠计划解析</span>
			<span class="caption-helper">管理收费优惠计划解析表配置...</span>
		</div>
	</div>
		...
		<div id="editparsModal" class="modal fade" tabindex="-1"
			...
			<div>
				<div class="modal-header">
					...
					<h4 class="modal-title">收费优惠计划解析表属性</h4>
				</div>
						...
						<div class="col-md-12">
							<form class="form-horizontal" role="form" id="edit_form">
								<div class="form-body">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-md-6 control-label">费用优惠起点类型</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-6 control-label">费用优惠起点</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-6 control-label">优惠利率</label>
											<div class="col-md-6">
...
<script src="${ctx}/pages/kcp/scripts/kcpfavoplex.js"></script>
<script>
