	...
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift font-green-sharp"></i> <span
				class="caption-subject font-green-sharp bold uppercase">场景事件维度值明细表</span>
			<span class="caption-helper">管理场景事件维度值明细表配置...</span>
		</div>
	</div>
		...
		<div id="editdimeModal" class="modal fade" tabindex="-1"
			...
			<div >
				<div class="modal-header">
					...
					<h4 class="modal-title">场景事件维度值明细表属性</h4>
				</div>
...
<script src="${ctx}/pages/kcp/scripts/kcpscevdime.js"></script>
<script>
