	...
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift font-green-sharp"></i> <span
				class="caption-subject font-green-sharp bold uppercase">累积优惠解析表</span>
			<span class="caption-helper">管理累积优惠解析表配置...</span>
		</div>
	</div>
		...
		<div id="editdefnModal" class="modal fade" tabindex="-1"
			...
			<div>
				<div class="modal-header">
					...
					<h4 class="modal-title">累积优惠解析属性</h4>
				</div>
							...
							<form class="form-horizontal" role="form">
								<div class="form-body">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label class="col-md-6 control-label">优惠计划维度类型</label>
											<div class="col-md-6">
												<input type="text" name="fadmtp"
													class="form-control input-inline input-medium form-value"
													 placeholder="优惠计划维度类型">
											</div>
										</div>
										<div class="form-group">
...
<script src="${ctx}/pages/kcp/scripts/kcpfavosmex.js"></script>
<script>
