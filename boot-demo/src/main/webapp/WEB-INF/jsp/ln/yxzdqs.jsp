	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">追代偿任务清算</span>
				<span class="caption-helper">追代偿任务清算</span>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover"
						id="yxzdqs_ajax" style="white-space: nowrap;">
						<thead>
...
<script src="${ctx}/pages/ln/scripts/yxzdqs.js"></script>
<script>
