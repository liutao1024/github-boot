	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">智能宝基金清算</span>
				<span class="caption-helper">智能宝基金清算...</span>
			</div>
		</div>
...
<script src="${ctx}/pages/fund/scripts/clearjjg.js"></script>
<script>
