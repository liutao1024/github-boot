	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">月月盈基金清算</span>
				<span class="caption-helper">月月盈基金清算...</span>
			</div>
		</div>
		...
		<div class="portlet-body">
			<form class="file-form form-horizontal" id = "file-form">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4" >汇款类型</label>
						<div class="input-group col-md-8">
							<input type="text" id="paychn" name="paychn" class="form-control input-inline" placeholder="请选择汇款类型"/>
						</div>
					</div>
				</div>
...
<script src="${ctx}/pages/fund/scripts/clearmi.js"></script>
<script>
