	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">月月盈基金对账展示</span>
				<span class="caption-helper">月月盈基金对账展示</span>
			</div>
		</div>
		<div class="portlet-body">
			<form class="form-horizontal fund-form" id="fund-form" role="form">
			 ...
			 <div class="table-container">
				<table class="table table-striped table-bordered table-hover" id="mibill_ajax">
					<thead>
...
<script src="${ctx}/pages/fund/scripts/ckeckMi.js"></script>
<script>
