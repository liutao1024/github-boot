	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">雨点保证金设置</span>
				<span class="caption-helper">雨点保证金设置...</span>
			</div>
		</div>
...
<script src="${ctx}/pages/yd/scripts/yddlbz.js"></script>
<script>
